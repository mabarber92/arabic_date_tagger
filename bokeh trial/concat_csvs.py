...
def dates_concat (URI, df_in, df_to_write, df_per_to_write, period_seg = True, period = 50, metadata = True, cols = ["predicted_year", "section word count"]):
...
for root, dirs, files in os.walk(".", topdown=False):
    for name in files:
        ...
        if df_in.empty:
            ...
            continue
        out, out_per = dates_concat(URI, df_in, out, out_per, period_seg = False, cols = ["predicted_year", "section word count"])

out.to_csv("C:/Users/mathe/Documents/Kitab project/Big corpus datasets/Github/arabic_date_tagger/bokeh trial/full_dates2", index=False, encoding= "utf-8-sig")
