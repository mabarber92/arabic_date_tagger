...
for root, dirs, files in os.walk(".", topdown=False):
    for name in files:
        ...
        if pri:
            ...
            print('')
            out_path = "C:/Users/mathe/Documents/Kitab project/Big corpus datasets/Github/arabic_date_tagger/Full_corpus_21_01/corpus_full/" + file_name + ".csv"
...
full_stats_df.to_csv("C:/Users/mathe/Documents/Kitab project/Big corpus datasets/Date tagger tests/Full_corpus_21_01/summary/full_stats.csv", index=False, encoding= "utf-8-sig")

full_stats_pre_df = pd.DataFrame(full_stats_pre, columns = ["Date_Before", "Header_count", "Word_count"])
full_stats_pre_df.to_csv("C:/Users/mathe/Documents/Kitab project/Big corpus datasets/Date tagger tests/Full_corpus_21_01/summary/pre_author_dates_stats.csv", index=False, encoding= "utf-8-sig")

error_rep_df = pd.DataFrame(error_rep, columns = ["text", 'negative count'])
error_rep_df.to_csv("C:/Users/mathe/Documents/Kitab project/Big corpus datasets/Date tagger tests/Full_corpus_21_01/summary/error_rep.csv", index=False, encoding = 'utf-8-sig')
